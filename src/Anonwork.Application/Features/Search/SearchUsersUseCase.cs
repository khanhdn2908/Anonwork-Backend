...
/// <summary>
/// Use case for searching users with pagination and privacy handling.
/// </summary>
public class SearchUsersUseCase(IUnitOfWork unitOfWork, IR2Service r2Service)
{
        ...
        CancellationToken ct = default)
    {
        ...
        var userDtos = pagedUsers.Select(u =>
        {
            ...
            var displayEmail = hasPermission && !isAnon ? u.Email : null;
